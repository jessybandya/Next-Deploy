...
export default function Header({ transcript, resetTranscript }) {
  ...
  useEffect(() => {
    if(transcript.includes('open')){
      ...
      logout()
      resetTranscript()
    }else if(transcript.includes('study')){
      handleOpen("lg")
      resetTranscript()
    }
  },[transcript])
    ...
    <Navbar style={{zIndex:100}} className="mx-auto max-w-screen-xl p-2 lg:rounded-full fixed top-0 left-0 right-0">
      <div className="relative mx-auto flex items-center text-blue-gray-900">
        <Link href="/" className="flex items-center">
         ...
         <span onClick={() => handleOpen("lg")} style={{ fontWeight: 'bold', marginRight: '5px', cursor:'pointer' }} className="text-gray-800 dark:text-white hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-1 lg:px-1 py-2 lg:py-2.5 mr-1 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800">Study</span>

         <Link href="/repos" style={{ fontWeight: 'bold', marginRight: '5px' }} className="text-gray-800 dark:text-white hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-1 lg:px-1 py-2 lg:py-2.5 mr-1 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800">Shop</Link>
  ...
  handler={handleOpen}
>
  <DialogHeader>Words For Voice Recognition</DialogHeader>
  <DialogBody divider
  style={{
